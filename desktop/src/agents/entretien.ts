...
export const INTITULES: Record<string, string> = {
  ...
  'paysage-espaces-verts': "Vos chantiers de paysage et vos espaces verts sont suivis avec quoi ?",
  ...
  'conception-cuisine-bain': "Vos implantations de cuisine et de salle de bains, vous les dessinez avec quoi ?",
  'cao-fao-usinage': "Vos programmes d'usinage, vous les sortez depuis quel logiciel ?",
  'prepresse-impression': "Vos fichiers avant impression, vous les préparez et les suivez dans quoi ?",
  ...
  'promotion-immobiliere': "Vos programmes, vos lots et vos appels de fonds sont suivis dans quoi ?",
  'logement-social': "Votre parc, vos attributions et vos quittances passent par quel logiciel ?",
  'secteur-public': "Votre comptabilité et vos actes de collectivité sont tenus dans quoi ?",
  'vie-scolaire': "Vos emplois du temps, vos notes et vos absences sont gérés dans quoi ?",
  'enseignement-superieur': "Vos inscriptions et votre scolarité passent par quelle application ?",
  ...
  'controle-technique': "Vos contrôles et vos procès-verbaux sortent de quel logiciel ?",
  'port-plaisance': "Vos places, vos contrats et vos escales sont gérés dans quoi ?",
  'jeu-video': "Votre jeu se fabrique sur quel moteur ?",
  'edition-livre': "Vos titres, vos commandes libraires et vos retours passent par quoi ?",
  ...
  'filiere-bois': "Vos chantiers de coupe et vos cubages sont suivis dans quel outil ?",
  equestre: "Vos pensions, vos cours et vos cavaliers sont gérés dans quoi ?",
  apiculture: "Vos ruchers et vos récoltes sont suivis avec quelle application ?",
  'horticulture-pepiniere': "Vos cultures et vos commandes de végétaux passent par quel logiciel ?",
