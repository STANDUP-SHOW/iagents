...
/// soit un connecteur. **4 547 tâches sur 9 233 n'ont ni l'un ni l'autre** :
...
pub struct Preparation {
    ...
    /// n'en désigne aucun, ce qui est le cas de 4 547 tâches sur 9 233.
...
mod tests {
    ...
    /// **Le test qui compte.** 4 547 tâches sur 9 233 ne désignent aucune source :
    ...
    /// Une entrée est un dossier ou rien : les 4 547 autres sont des mots qui
